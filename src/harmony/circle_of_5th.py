...
class CircleOf5th:
    ...
    def get_chord_names_possible_qualities(self, chord: str) -> [str]:
        """
    ...
    def generate_circle_of_fifths_melodic_minors(self) -> {}:
        """
        generates the circle_of_fifths_natural_majors
        https://music.utk.edu/theorycomp/courses/murphy/documents/Major+MinorScales.pdf
        :return:
    ...
    def guess_tone_and_mode(self, cp: ChordProgression) -> []:
        guess = self.guess_tone_from_circle_of_fifths(cp, self.circle_of_fifths_natural_majors, "Natural Major")
        return guess
